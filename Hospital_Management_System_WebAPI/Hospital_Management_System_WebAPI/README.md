...
The   Hospital Management System   is a comprehensive ASP.NET Core 8 Web API designed to manage hospital operations efficiently. It provides endpoints for patient registration, doctor management, appointment scheduling, and generating business reports. The system includes email notification features and follows industrystandard architectural patterns.

The application is built using a   3tier architecture   with separation of concerns: Controllers, Services, and Repositories, ensuring maintainability and scalability.
 ...
 CORS enabled for crossorigin requests
...
Database Schema
 ...
 Relationships: Referenced by Appointments table
       ...
       Appointments Table  
 Records patientdoctor appointments and statuses
...
The project uses .NET Core's builtin DI container configured in `Program.cs`:
csharp
  ...
  "data": [
    {
      ...
      "appointmentDate": "20240610T09:00:00Z",
      "status": "Scheduled",
...
1.   Database Indexes  : Created on commonly queried columns (PatientCode, DoctorSpecialization, AppointmentDate)
